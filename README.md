...
最新可见结果为 2026-06-21 13:15:41：编译状态 `Accepted`，总分
`484.26735406790885`。其中 RISC-V basic 为 `204`，BusyBox 为 `98`，Lua 为
`18`，libcbench 为 `57.26735406790887`，musl libctest 为 `107`。这说明撤回
`8690e03` 的 iozone-lite 后已经恢复 484 基线，且当前分数波动主要来自
libcbench 性能项。
