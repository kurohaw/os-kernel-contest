...
/// Linux statx buffer layout on 64-bit Linux.
...
impl Statx {
    pub fn new() -> Self {
        // Keep exact Linux layout while defaulting unsupported fields to zero.
        unsafe { core::mem::zeroed() }
    }
}

pub const STATX_SIZE: usize = size_of::<Statx>() as usize;
...
/// UtsName
// const SYSNAME: &str = "SWTC";
// const NODENAME: &str = "SWTC";
// const RELEASE: &str = "SWTC 1.0.0";
