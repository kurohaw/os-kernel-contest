...
| 项目 | 状态 | 结果 |
|---|---|---|
| 官方页面最后可见结果 | 基线已恢复 | 2026-06-20 21:09:40，`Accepted / 397.32511382265227`；basic=204、BusyBox=98、Lua=18、libcbench=57.325113822652256、libctest=20 |
| 最新稳定官方结果 | 通过并新增 libctest 得分 | 2026-06-20 21:09:40，`Accepted / 397.32511382265227`；libctest-musl=20，libcbench 约 57.33 分 |
...
| 上一条高分结果 | 通过并得分 | 2026-06-20 21:09:40，`Accepted / 397.32511382265227`；basic=204、BusyBox=98、Lua=18、libcbench=57.325113822652256、libctest=20 |
...
| `C` libctest 队列协议 | 已线上验证 20 case | 支持 `C<timeout_ms>\t<entry-static.exe>\t<case>`，按真实退出码输出 per-case START/END、`Pass!` 或 `FAIL` |
...
| libcbench staging | 已恢复基线 | 21:09 线上 libcbench 合计 57.325113822652256；`b433976` 的 readlinkat 回退问题已止血 |
| musl libctest staging | 本轮小批量扩到 24 case | 已验证 20 case；本轮只新增 `search_hsearch/search_insque/search_lsearch/search_tsearch` |
